...
class SortingWithProgress(Sorting):
    def __init__(self):
        self.steps = []

    def sort(self, arr):
        self.steps = []
        return self._sort_with_progress(arr)

    def _sort_with_progress(self, arr):
        raise NotImplementedError("Subclasses must implement _sort_with_progress method.")


class SelectionSort(SortingWithProgress):
    def _sort_with_progress(self, arr):
...
class RadixSort(SortingWithProgress):
